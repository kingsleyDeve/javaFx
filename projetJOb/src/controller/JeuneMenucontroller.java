...
public class JeuneMenucontroller {
    ...
    {    
                    ...
                    try
                    {
                        ...
                        loader.setLocation(Main.class.getClassLoader().getResource("view/JeuneCnx.fxml"));
...
//                    
    ...
    {    
                          ...
                          {
              	            FXMLLoader loader = new FXMLLoader();
              	            loader.setLocation(Main.class.getClassLoader().getResource("view/JeuneInscri.fxml"));
              	           AnchorPane mainPane = (AnchorPane) loader.load();
